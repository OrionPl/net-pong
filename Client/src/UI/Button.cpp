...
Button::Button(std::string _name, bool _active,  int _uiAnchor, int _xPos, int _yPos, int _xSize, int _ySize, SDL_Texture* _texture, SDL_Renderer* _renderer, std::string _text, Text* text) : UIElement(_name, _active, _uiAnchor, _xPos, _yPos, _xSize, _ySize, _texture, _renderer) {
    textTexture = text->CreateTexture(renderer, _text);
}
...
Button::Button(std::string _name, bool _active,  int _uiAnchor, int _xPos, int _yPos, int _xSize, int _ySize, bool _filled, SDL_Color _color, SDL_Renderer* _renderer, std::string _text, Text* text) : UIElement(_name, _active, _uiAnchor, _xPos, _yPos, _xSize, _ySize, _filled, _color, _renderer) {
    textTexture = text->CreateTexture(renderer, _text);
}
